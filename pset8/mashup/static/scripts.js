...
$(document).ready(function() {
    ...
    let options = {
        center: {lat: 37.5483, lng: -121.9886}, // Fremont, California
...
{
    /*
     * Given a `place` (i.e., postal code and more), this function
     * will add a marker (i.e., icon) to the map.
     */
    ...
    // [x] remember marker in markers list
    markers.push(marker);
}
